...
$$
DECLARE
    seller_role_id BIGINT;
    user_role_id BIGINT;
    admin_role_id BIGINT;
    user_id BIGINT;
    user_only_id BIGINT;
    admin_only_id BIGINT;
BEGIN
    -- Fetch role IDs
...
-- Insert User
INSERT INTO "Users" ("Guid", "FirstName", "LastName", "Email", "CreatedAt", "UpdatedAt", "PasswordHash", "PasswordSalt", "TokenProvider")
VALUES (gen_random_uuid(), 'SellerJohn', 'Doe', 'seller@email.com', now(), now(), E'\\x2AD6CAFC54764BAB95007CA0EE4195BC3CEAE57580BC0024CD0BC582DCE20ED62EB3DA43BBF81F582E9C6D6F1007997682A23B617DE3533D218E7C392E706B4D', E'\\x01D5C65E2C3769D009B9981C560E3FC22753595418BD4224A711CE8136B6FE98B41BD296D325E65BC1553BA82CEBA4030F7889857CB94C0978A3219250C5E9B5FBE6BA40C6C5CA375849A98C8518F5D4E190CDFBC07F4F3B7AC15FB9FACB39354BF5BB69C6E01432FD6871CA288DB69CE3ED2D62BE2A90AD414B7A17318591C3', 'RetailPortalApp')
    RETURNING "Id" INTO user_id;

-- Insert User-only User
INSERT INTO "Users" ("Guid", "FirstName", "LastName", "Email", "CreatedAt", "UpdatedAt", "PasswordHash", "PasswordSalt", "TokenProvider")
VALUES (gen_random_uuid(), 'UserJane', 'Doe', 'user@email.com', now(), now(), E'\\x2AD6CAFC54764BAB95007CA0EE4195BC3CEAE57580BC0024CD0BC582DCE20ED62EB3DA43BBF81F582E9C6D6F1007997682A23B617DE3533D218E7C392E706B4D', E'\\x01D5C65E2C3769D009B9981C560E3FC22753595418BD4224A711CE8136B6FE98B41BD296D325E65BC1553BA82CEBA4030F7889857CB94C0978A3219250C5E9B5FBE6BA40C6C5CA375849A98C8518F5D4E190CDFBC07F4F3B7AC15FB9FACB39354BF5BB69C6E01432FD6871CA288DB69CE3ED2D62BE2A90AD414B7A17318591C3', 'RetailPortalApp')
    RETURNING "Id" INTO user_only_id;

-- Insert Admin User
INSERT INTO "Users" ("Guid", "FirstName", "LastName", "Email", "CreatedAt", "UpdatedAt", "PasswordHash", "PasswordSalt", "TokenProvider")
VALUES (gen_random_uuid(), 'AdminJake', 'Smith', 'admin@email.com', now(), now(), E'\\x2AD6CAFC54764BAB95007CA0EE4195BC3CEAE57580BC0024CD0BC582DCE20ED62EB3DA43BBF81F582E9C6D6F1007997682A23B617DE3533D218E7C392E706B4D', E'\\x01D5C65E2C3769D009B9981C560E3FC22753595418BD4224A711CE8136B6FE98B41BD296D325E65BC1553BA82CEBA4030F7889857CB94C0978A3219250C5E9B5FBE6BA40C6C5CA375849A98C8518F5D4E190CDFBC07F4F3B7AC15FB9FACB39354BF5BB69C6E01432FD6871CA288DB69CE3ED2D62BE2A90AD414B7A17318591C3', 'RetailPortalApp')
...
-- Core Seeding Script: Roles, Users
DO
$$
BEGIN
-- Seed Roles
INSERT INTO "Roles" ("Guid", "Name", "Description", "CreatedAt", "UpdatedAt")
...
PERFORM seed_users_and_roles();
        RAISE NOTICE 'Roles, and Users seeded successfully.';
END;
$$ LANGUAGE plpgsql;
